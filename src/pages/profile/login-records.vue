...
const {
  ...
  execute,
} = useAxios<{ data: { records: LoginRecord[]; total: number } }>("/login-records/me", fetcher, {
  immediate: false,
});
...
async function fetchData() {
  ...
  await execute(`/login-records/me?${params.toString()}`);
...
function downloadCsv() {
  ...
  window.open(`${baseUrl}/login-records/me/download`, "_blank");
}
